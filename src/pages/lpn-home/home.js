        ...
        return (
            <div>
                ...
                <Navbar id='navbar' bg="light" expand="lg">
                    ...
                    <Container style={{height: 'fit-content', maxWidth:'100vw', border: '1px solid blue',  backgroundImage: `url(${aboutBg})`, padding: '150px', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
                        <Row>
                            <Col>
                                <ChartSection />
                            </Col>
